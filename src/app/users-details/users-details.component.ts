...
constructor (private _reseller: ResellerService) {}
  ...
  dDay = new Date(
    `Nov ${parseInt(this.date[2]) + 1}, 2023 ${this.getHours}:${this.getMinutes}:${this.getSeconds}`
  ).getTime();
...
private allocateMinutesUnits (timeDifference: any) {
  this.secondsToDday1 = Math.floor((timeDifference) / (this.milliSecondsInASecond) % this.SecondsInAMinute);
  this.minutesToDday1 = Math.floor((timeDifference) / (this.milliSecondsInASecond * this.minutesInAnHour) % this.SecondsInAMinute);
  this.hoursToDday1 = Math.floor((timeDifference) / (this.milliSecondsInASecond * this.minutesInAnHour * this.SecondsInAMinute) % this.hoursInADay);
  this.daysToDday1 = Math.floor((timeDifference) / (this.milliSecondsInASecond * this.minutesInAnHour * this.SecondsInAMinute * this.hoursInADay));
}
